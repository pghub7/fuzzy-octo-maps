...
public class EarthquakeCityMap extends PApplet {
	...
	public void mouseClicked()
	{
		...
		// finding the last clicked marker
		checkCities();
		checkQuakes();
		 ...
		 if(lastClicked instanceof CityMarker) {
			...
			double threat = ((EarthquakeMarker) lastClicked).threatCircle();
			for(Marker M : cityMarkers) {
				if(M.getDistanceTo(lastClicked.getLocation()) > threat) {
					M.setHidden(true);
				}
			}
			for(Marker M: quakeMarkers) {
