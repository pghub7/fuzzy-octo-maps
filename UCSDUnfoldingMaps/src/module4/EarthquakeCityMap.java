...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
	    ...
	    //	System.out.println(quakeMarkers.get(i).getProperties());
	   // }

	    
	    //System.out.println(cityMarkers.get(0).getProperty("name"));
	...
	private void addKey() {	
		...
		text("Size~Magnitude",44,215);
		text("Shallow",75,255);
		text("Intermediate",75,295);
		text("Deep",75,335);
		text("Past Day",75, 385);
		...
		fill(color(255, 0, 0));
		ellipse(50, 335, 15, 15);
		
		fill(255,255,255);
		ellipse(50,385,15,15);
		line(50-15,385-15,50+15,385+15);
		line(50+15,385-15,50-15,385+15);
		...
		for(Marker cm : countryMarkers) {
			 String countryName = (String) cm.getProperty("name");
			  ...
			  for(Marker m : quakeMarkers) {
				  EarthquakeMarker em = (EarthquakeMarker)m;
				  if(em.isOnLand) {
					  String quakeCountry = (String) m.getProperty("country");
					  if(countryName == quakeCountry)
						  landQuakeCounter+=1;
				  }
			  }
			  if(landQuakeCounter>=1)
