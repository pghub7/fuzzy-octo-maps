...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(1400, 800, P2D);  // Set up the Applet window to be 800x600
		...
		AbstractMapProvider msProvider = new Microsoft.RoadProvider();
		...
		map1 = new UnfoldingMap(this, 50, 50, 1200, 1200, msProvider);
		...
		map2 = new UnfoldingMap(this, 1400, 50, 1200, 1200, msProvider);
		map2.zoomAndPanTo(30, new Location(49.2596401f,-123.2516941f));
		Location rez = new Location(49.2596401f,-123.2516941f);
		SimplePointMarker myRez = new SimplePointMarker(rez);
		map2.addMarker(myRez);
